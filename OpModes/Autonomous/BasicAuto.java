...
//        pressAToContinue();
        ...
        Billy.IMUDriveFwdRight(HardwareBilly.moveDirection.FwdBack, (-(bridgeBack + cons.backTowardsBridge)), -180 * sideColor, "Back 2 inches",this);
...
//        Billy.IMUDriveFwdRight(HardwareBilly.moveDirection.FwdBack, 5, -90 * sideColor, "Forward 5 inches with Foundation", this);
    ...
    public void grabFoundationSideways() {
        ...
        Billy.IMUDriveFwdRight(HardwareBilly.moveDirection.RightLeft, -12 * sideColor, 0, "Left 12 inches", this);//NEW
